...
/**
 * <p>Java class for ArrayOfObjectDefinitionRequest complex type.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="ObjectDefinitionRequest" type="{http://exacttarget.com/wsdl/partnerAPI}ObjectDefinitionRequest" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class ArrayOfObjectDefinitionRequest {
     ...
     * This is why there is not a <CODE>set</CODE> method for the objectDefinitionRequest property.
     * 
     * <p>
    ...
    public List<ObjectDefinitionRequest> getObjectDefinitionRequest() {
        if (objectDefinitionRequest == null) {
            objectDefinitionRequest = new ArrayList<ObjectDefinitionRequest>();
        }
