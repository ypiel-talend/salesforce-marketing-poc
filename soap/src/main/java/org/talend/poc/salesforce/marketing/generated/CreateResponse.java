 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Results" type="{http://exacttarget.com/wsdl/partnerAPI}CreateResult" maxOccurs="unbounded"/&gt;
...
public class CreateResponse {
    ...
    protected List<CreateResult> results;
     ...
     * 
     */
    public List<CreateResult> getResults() {
        if (results == null) {
            results = new ArrayList<CreateResult>();
        }
        return this.results;
    }
