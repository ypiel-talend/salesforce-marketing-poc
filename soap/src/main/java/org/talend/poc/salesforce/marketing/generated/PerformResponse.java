...
/**
 * <p>Java class for PerformResponse complex type.
 * 
...
@XmlType(name = "PerformResponse", propOrder = {
    "statusCode",
    "statusMessage",
    "ordinalID",
    "results",
...
public class PerformResponse {
    ...
    protected PerformResponse.Results results;
     ...
     * @return
     *     possible object is
     *     {@link PerformResponse.Results }
     *     
     */
    public PerformResponse.Results getResults() {
        return results;
    }
     ...
     *     
     */
    public void setResults(PerformResponse.Results value) {
        this.results = value;
    }
