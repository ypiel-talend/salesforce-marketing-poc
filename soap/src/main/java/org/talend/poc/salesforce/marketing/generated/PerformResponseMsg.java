...
@XmlRootElement(name = "PerformResponseMsg")
public class PerformResponseMsg {
     ...
     * @return
     *     possible object is
     *     {@link PerformResponseMsg.Results }
     *     
     */
     ...
     *     
     */
    public void setResults(PerformResponseMsg.Results value) {
        this.results = value;
    }
    ...
    public static class Results {
        ...
        protected List<PerformResult> result;
         ...
         * 
         */
        public List<PerformResult> getResult() {
            if (result == null) {
                result = new ArrayList<PerformResult>();
            }
            return this.result;
        }
