 ...
 *         &lt;element name="Results" type="{http://exacttarget.com/wsdl/partnerAPI}APIObject" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "RetrieveResponseMsg")
public class RetrieveResponseMsg {
    ...
    protected List<APIObject> results;
     ...
     * 
     */
    public List<APIObject> getResults() {
        if (results == null) {
            results = new ArrayList<APIObject>();
        }
        return this.results;
    }
