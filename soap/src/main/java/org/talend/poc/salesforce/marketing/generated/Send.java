    ...
    extends APIObject
{
    ...
    protected java.util.List<org.talend.poc.salesforce.marketing.generated.List> list;
    ...
    @XmlElementRef(name = "SentDate", namespace = "http://exacttarget.com/wsdl/partnerAPI", type = JAXBElement.class, required = false)
     ...
     * 
     */
    public java.util.List<org.talend.poc.salesforce.marketing.generated.List> getList() {
        if (list == null) {
            list = new ArrayList<org.talend.poc.salesforce.marketing.generated.List>();
        }
        return this.list;
    }
