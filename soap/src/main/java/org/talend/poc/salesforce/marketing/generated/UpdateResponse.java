 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Results" type="{http://exacttarget.com/wsdl/partnerAPI}UpdateResult" maxOccurs="unbounded"/&gt;
...
public class UpdateResponse {
    ...
    protected List<UpdateResult> results;
    ...
    public List<UpdateResult> getResults() {
        if (results == null) {
            results = new ArrayList<UpdateResult>();
        }
        return this.results;
    }
